...
<div id="page">
    <div id="main">
        ...
        <div id="content" class="column" role="main">
            ...
            <div class="hola-message">
                <div class="texto-hola">hola</div>
                <div class="texto-quien-eres">
                    <div>¿quién eres?</div>
                    <div style="clear:both; margin-left: 19px;" class="sprite-gray_2px_lin sprite"></div>
                    <div class="sprite-gray_2px_lin sprite"></div>
                    <div class="sprite-gray_2px_lin sprite"></div>
                    <div style="width:18px;" class="sprite-gray_2px_lin sprite"></div>
                    <div style="clear: both"></div>
                </div>
                <a class="saltar dk" href="/el-trabajo">
                    SALTAR
