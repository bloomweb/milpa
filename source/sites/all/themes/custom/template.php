...
function THEME_js_alter(&$javascript) {
    ...
    $jquery_path = drupal_get_path('theme','custom') . '/js/jquery.js';
 ...
 //- See more at: http://www.rgracia.com/content/blog/may/12/2013/how-update-jquery-your-drupal-7-theme#sthash.DfrbU9QA.dpuf
}