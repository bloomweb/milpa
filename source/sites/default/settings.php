	...
	$databases = array (
		'default' =>
			array (
				'default' =>
					array (
						'database' => 'bloomweb_milpa',
						'username' => 'bloomweb',
						'password' => 'rr40r900343',
						'host' => (($_SERVER['HTTP_HOST'] == 'milpa.bloomweb.co') ? 'mysql.bloomweb.co' : 'localhost'),
						'port' => '',
						'driver' => 'mysql',
						'prefix' => '',
					),
 ...
 *
 */
$drupal_hash_salt = 'SOwT1c-84Tal6-IveW9bF2385qOH_-WQ1alGIOae92I';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/devdesktop_milpa_local.inc'))
  require($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/devdesktop_milpa_local.inc');
//</DDSETTINGS>
